...
export function TextReveal({
  ...
  // React 19's ElementType union is too wide to render through directly;
  // narrow it to the three props this component actually sets.
  const Tag = Comp as unknown as (props: {
    ref?: Ref<HTMLElement>;
    className?: string;
    children?: ReactNode;
  }) => ReactNode;
